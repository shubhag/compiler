		...
		for line in TAC.code[function]:
			...
			if line[3] == '+':
				...
				if not line[2]:
					...
					if line[2][0] == '*': 
						AC.addCommand(['movl', str(offset2)+'(%esp)' , '%eax'])
						AC.addCommand(['addl', '(%eax)' , '%eax'])
					else:
